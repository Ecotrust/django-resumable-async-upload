...
class TestResumableStorage:
    ...
    @override_settings(ADMIN_RESUMABLE_CHUNK_STORAGE='django.core.files.storage.FileSystemStorage')
    ...
    @override_settings(ADMIN_RESUMABLE_STORAGE='django.core.files.storage.FileSystemStorage')
    ...
    def test_full_filename_with_callable_upload_to(self):
        ...
        storage = ResumableStorage()
        mock_instance = Mock()
        filename = storage.full_filename('test.txt', custom_upload_to, instance=mock_instance)
