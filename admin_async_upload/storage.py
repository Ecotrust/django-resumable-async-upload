...
class ResumableStorage(object):
    ...
    def __init__(self):
        ...
        self.persistent_storage_name = getattr(settings, 'ADMIN_RESUMABLE_STORAGE', None)
        self.chunk_storage_name = getattr(settings, 'ADMIN_RESUMABLE_CHUNK_STORAGE', None)
    ...
    def get_chunk_storage(self, *args, **kwargs):
        ...
        if storages:
            ...
            # Fallback for older Django versions
            chunk_storage_class_name = self.chunk_storage_name or 'django.core.files.storage.FileSystemStorage'
    ...
    def get_persistent_storage(self, *args, **kwargs):
        ...
        if storages:
            ...
            # Fallback for older Django versions
            persistent_storage_class_name = self.persistent_storage_name or \
